    ...
    def evaluate(self, N=1000, T=2, seed=None, initial_level=10,
        ...
        **kwargs : optional.
        ...
        sample_count_array : np.array(int)
            ...
            simulation.
        """
        from ETCetera.util import etcsim
...
if __name__ == '__main__':
    ...
    Ap = np.array([[1.38, -0.208, 6.715, -5.676], [-0.581, -4.29, 0, 0.675], [1.067, 4.273, -6.654, 5.893],
                  [0.048, 4.273, 1.343, -2.104]])
    Bp = np.array([[0, 0], [5.679, 0], [1.136, 3.146], [1.136, 0]])
    h = 0.01
    Cp = np.eye(4)
    nx = len(Ap)
    nu = len(Bp[1])
