...
from control_system_abstractions.exceptions.parser_exceptions.general_parser_exception import IncorrectSyntaxException, \
    ...
    if line.split(':')[0].strip() == 'Dynamics':
        ...
        for matrix in value:
            ...
            if len(shape) == 0 or shape[0] == shape_current[0]:
                ...
                raise MatricesUnequalRowsException
