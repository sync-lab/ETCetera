...
traffic = abstr.TrafficModelNonlinearETC(dynamics, trigger, state_vector, state_space_limits=state_space_limits, grid_points_per_dim=grid_points_per_dim, manifolds_times=[0.002, 0.0038, 0.0065, 0.0075], partition_method='manifold', heartbeat=0.021, order_approx=4)
