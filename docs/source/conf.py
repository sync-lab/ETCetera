...
# ones.
extensions = ['sphinx.ext.mathjax', 'sphinx.ext.intersphinx', 'sphinx.ext.autodoc']
intersphinx_mapping = {'python': ('https://docs.python.org/3', None), 'numpy': ('http://docs.scipy.org/doc/numpy/', None), 'sympy':('https://docs.sympy.org/latest', None)}
...
# documentation.
#
html_theme_options = {'body_min_width': '95%'}
