...
directory if you want to install them. You can download them from below location:
 ...
 Finally, add the paths to ``config.py``, e.g.
   ```python
   dreal_path = '*/sentient/third-party/dreal4/bazel-bin/dreal/dreal'
   dreach_path = '*/sentient/third-party/dReal-3.16.06.02-*/bin/dReach'
   flowstar_path = '*/sentient/third-party/flowstar-2.0.0/flowstar-2.0.0/flowstar'
   ```
   ...
   ```python
   dreal_path = '<path>/uppaal64-4.1.20-stratego-7/bin-Linux/verifyta'
   ```
### Conda
